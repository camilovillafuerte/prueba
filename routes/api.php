...
Route::get('/sql','App\Http\Controllers\Becas_nivelController@index');//mostrar todos los registros
...
Route::get('/becas_body','App\Http\Controllers\Becas_nivel_bodyController@index');//mostrar todos los registros
