...
class ConveniosController extends Controller
{
    ...
    public function updateAllConvenio(Request $request){
        ...
        $tipoConv = $this->_updateTipoConvenio($convenio->id, $data->comparecientes, $data->id_tipoconvenio, $data->id_tipoespecifico);
        ...
        $historial->usuario_id = intval($data->id_usuario);
        $historial->titulo = "Modificación";
        $historial->detalle = "Se modifico el convenio ".$data->nombre_convenio;
