...
class SolicitudesController extends Controller
{
    ...
    public function solicitud($id)
    {
        ...
        a.id as id_alergias, a.descripcion as Alergias, ea.id as is_especificar_alergias, ea.especificar_alergia, en.id as id_enfermedades_cronicas, en.enfermedades_tratamiento,s.poliza_seguro,pdf.id as id_pdf, 
