...
class Interfaz_contenidoController extends Controller
{
    ...
    public function getInterfazconprueba(){
        ...
        ->select('interfazs.nombre','interfazs.pagina', 'interfaz_contenidos.id_interfazs','interfaz_contenidos.nombre','interfaz_contenidos.descripcion','interfaz_contenidos.urlimagen','interfaz_contenidos.estado')
        -> where('estado','A') 
        -> get();
